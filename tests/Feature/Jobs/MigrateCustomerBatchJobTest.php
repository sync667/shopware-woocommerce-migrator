...
class MigrateCustomerBatchJobTest extends TestCase
{
    ...
    {
        $this->assertSame(
            'shared+sw_210855f6@example.com',
            MigrateCustomerBatchJob::aliasEmail('shared@example.com', '210855f6dc2947948583d94a6ee33edb')
        );
    }
    ...
    {
        $this->assertSame(
            'user+old@host+sw_12345678@example.com',
            MigrateCustomerBatchJob::aliasEmail('user+old@host@example.com', '12345678abcdef')
        );
    }
